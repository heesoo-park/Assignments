...
class Calculator {
    ...
    init {
        println("계산기 ON")
        accNum = Double.MIN_VALUE
    }

    fun add(addOperation: AddOperation, n1: Double, n2: Double): Double {
        accNum = addOperation.operation(n1, n2)
        return accNum
    }

    fun substract(substractOperation: SubstractOperation, n1: Double, n2: Double): Double {
        accNum = substractOperation.operation(n1, n2)
        return accNum
    }

    fun multiply(multiplyOperation: MultiplyOperation, n1: Double, n2: Double): Double {
        accNum = multiplyOperation.operation(n1, n2)
        return accNum
    }

    fun divide(divideOperation: DivideOperation, n1: Double, n2: Double): Double {
        accNum = divideOperation.operation(n1, n2)
        return accNum
    }
...
//         return when (symbol) {
//             1 -> addOperation.add(n1, n2)
//             2 -> substractOperation.substract(n1, n2)
//             3 -> multiplyOperation.multiply(n1, n2)
//             4 -> divideOperation.divide(n1, n2)
